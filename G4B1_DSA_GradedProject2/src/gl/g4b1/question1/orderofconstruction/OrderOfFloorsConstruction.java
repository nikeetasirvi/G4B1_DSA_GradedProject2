package gl.g4b1.question1.orderofconstruction;

import java.util.ArrayList;
import java.util.Collections;
import java.util.LinkedList;

public class OrderOfFloorsConstruction {

	public void orderOfConstruction(ArrayList<Integer> list, int noOfFloors) {
